...
# ==================== App Setup ====================
app = FastAPI(
    title="Datadiv AI — Guardrailed Backend",
    description="Datadiv AI backend protected by NeMo Guardrails",
    version="1.0.0"
)
...
def fallback_check_input(message: str) -> tuple[bool, str]:
    ...
    for pattern in INJECTION_PATTERNS:
        if pattern.search(message):
            ...
            return False, "I'm Datadiv AI, your data analysis assistant. I can't change my role or ignore my guidelines."
...
async def root():
    ...
    return {
        "service": "Datadiv AI — Guardrailed Backend",
        "status": "running",
...
def generate_fallback_response(message: str) -> str:
    ...
    if any(w in message_lower for w in ["hi", "hello", "hey", "greetings"]):
        return "Hello! I'm Datadiv AI, your data analysis assistant. Upload a CSV file to get started, or ask me anything about data analysis!"
...
if __name__ == "__main__":
    ...
    print("=" * 50)
    print("  Datadiv AI — Guardrailed Backend")
